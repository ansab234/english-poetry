...
public class i_m_no_more_here_13_Activity extends AppCompatActivity {
    private final String TAG = i_m_no_more_here_13_Activity.class.getSimpleName();


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_i_m_no_more_here_13_);
    ...
    private void fb_banner_ad() {
        ...
        final AdView adView = new AdView(i_m_no_more_here_13_Activity.this, this.getString
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.share_btn:
                ...
                myintent.putExtra(Intent.EXTRA_TEXT,"  I am no more here\n    " +
                        "          Poet: Muniza Wasi\n\n"+
