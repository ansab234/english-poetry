...
public class whenever_14_Activity extends AppCompatActivity {
    private final String TAG = whenever_14_Activity.class.getSimpleName();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_whenever_14_);
    ...
    private void fb_banner_ad() {
        ...
        final AdView adView = new AdView(whenever_14_Activity.this, this.getString
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.share_btn:
                ...
                myintent.putExtra(Intent.EXTRA_TEXT, "  Whenever\n    " +
                        "          Poet: Muniza Wasi\n\n" +
